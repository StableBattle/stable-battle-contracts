...
abstract contract TestSetups is Test, DeployStableBattle {
    ...
    address immutable richUSDTAddress = vm.envAddress("RICHUSDT_ADR");
    string goerliForkURL = vm.envString("MODE_URL");

    function setupStableBattle(address deployer) internal returns (IStableBattle, IBEER, ISBV) {
