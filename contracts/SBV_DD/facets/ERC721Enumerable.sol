...
import "./ERC721.sol";
import "../../shared/interfaces/IERC721Enumerable.sol";
...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
     ...
     * while the token is not assigned a new owner, the `s._ownedTokensIndex` mapping is _not_ updated: this allows for
     * gas optimizations e.g. when performing a transfer operation (avoiding double writes).
     * This has O(1) time complexity, but alters the order of the s._ownedTokens array.
     ...
     * This has O(1) time complexity, but alters the order of the s._allTokens array.
